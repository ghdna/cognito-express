...
cognito-express is a npm-module that authenticates API requests on a Node application by verifying the JWT signature of AccessToken or IDToken generated by Amazon Cognito.
...
This is a simple module that authenticates web APIs by verifying the JWT signature of AccessToken or IDToken - without needing to call Amazon Cognito for each API invocation. 
